        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted leading-relaxed max-w-xs">
              A modern dental clinic led by two certified dentists, committed to
              precision care and lasting oral health.
            </p>
            {/* Social icons */}
            <div className="flex items-center gap-4 mt-6">
              ...
              <a
                href="https://www.instagram.com/denluxdental/"
                target="_blank"
                className="text-muted hover:text-foreground transition-colors"
...
*/}
        ...
        <div className="mt-16 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted">
            &copy; {new Date().getFullYear()} Denlux Dental. All rights
            reserved.
          </p>
